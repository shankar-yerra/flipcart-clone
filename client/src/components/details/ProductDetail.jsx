...
`; // parent ki help se jo child elements he usme me css ko change karou
...
const ProductDetail = ({ product }) => {
  ...
  // gettime will give current date in milli seconds..we added 5 days to it.to make date readeble use toDateString().
